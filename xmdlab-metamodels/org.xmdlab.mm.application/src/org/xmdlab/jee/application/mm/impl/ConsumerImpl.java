 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getModule <em>Module</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getRepositoryDependencies <em>Repository Dependencies</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getServiceDependencies <em>Service Dependencies</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getChannel <em>Channel</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getMessageRoot <em>Message Root</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getOtherDependencies <em>Other Dependencies</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ConsumerImpl#getSubscribe <em>Subscribe</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConsumerImpl extends NamedElementImpl implements Consumer
{
	...
	{
		return JeeApplicationMmPackage.Literals.CONSUMER;
	}
	...
	{
		if (eContainerFeatureID() != JeeApplicationMmPackage.CONSUMER__MODULE) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newModule, JeeApplicationMmPackage.CONSUMER__MODULE, msgs);
		return msgs;
	}
	...
	{
		if (newModule != eInternalContainer() || (eContainerFeatureID() != JeeApplicationMmPackage.CONSUMER__MODULE && newModule != null))
		{
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, JeeApplicationMmPackage.MODULE__CONSUMERS, Module.class, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.CONSUMER__MODULE, newModule, newModule));
	}
	...
	public EList<Repository> getRepositoryDependencies()
	{
		...
		{
			repositoryDependencies = new EObjectResolvingEList<Repository>(Repository.class, this, JeeApplicationMmPackage.CONSUMER__REPOSITORY_DEPENDENCIES);
		}
	...
	public EList<Service> getServiceDependencies()
	{
		...
		{
			serviceDependencies = new EObjectResolvingEList<Service>(Service.class, this, JeeApplicationMmPackage.CONSUMER__SERVICE_DEPENDENCIES);
		}
	...
	public void setChannel(String newChannel)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.CONSUMER__CHANNEL, oldChannel, channel));
	}
	...
	public DomainObject getMessageRoot()
	{
		if (messageRoot != null && messageRoot.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.CONSUMER__MESSAGE_ROOT, oldMessageRoot, messageRoot));
			}
		}
		return messageRoot;
	}
	...
	public void setMessageRoot(DomainObject newMessageRoot)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.CONSUMER__MESSAGE_ROOT, oldMessageRoot, messageRoot));
	}
	...
	public EList<String> getOtherDependencies()
	{
		...
		{
			otherDependencies = new EDataTypeUniqueEList<String>(String.class, this, JeeApplicationMmPackage.CONSUMER__OTHER_DEPENDENCIES);
		}
	...
	public Subscribe getSubscribe()
	{
		if (subscribe != null && subscribe.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.CONSUMER__SUBSCRIBE, oldSubscribe, subscribe));
			}
		}
		return subscribe;
	}
	...
	public void setSubscribe(Subscribe newSubscribe)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.CONSUMER__SUBSCRIBE, oldSubscribe, subscribe));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.CONSUMER__MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case JeeApplicationMmPackage.CONSUMER__MODULE:
				return eInternalContainer().eInverseRemove(this, JeeApplicationMmPackage.MODULE__CONSUMERS, Module.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.CONSUMER__MODULE:
				return getModule();
			case JeeApplicationMmPackage.CONSUMER__REPOSITORY_DEPENDENCIES:
				return getRepositoryDependencies();
			case JeeApplicationMmPackage.CONSUMER__SERVICE_DEPENDENCIES:
				return getServiceDependencies();
			case JeeApplicationMmPackage.CONSUMER__CHANNEL:
				return getChannel();
			case JeeApplicationMmPackage.CONSUMER__MESSAGE_ROOT:
				if (resolve) return getMessageRoot();
				return basicGetMessageRoot();
			case JeeApplicationMmPackage.CONSUMER__OTHER_DEPENDENCIES:
				return getOtherDependencies();
			case JeeApplicationMmPackage.CONSUMER__SUBSCRIBE:
