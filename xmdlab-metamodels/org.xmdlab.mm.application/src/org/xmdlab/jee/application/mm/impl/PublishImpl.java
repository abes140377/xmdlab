 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.PublishImpl#getEventBus <em>Event Bus</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.PublishImpl#getTopic <em>Topic</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.PublishImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PublishImpl extends MinimalEObjectImpl.Container implements Publish
{
	...
	{
		return JeeApplicationMmPackage.Literals.PUBLISH;
	}
	...
	public void setEventBus(String newEventBus)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.PUBLISH__EVENT_BUS, oldEventBus, eventBus));
	}
	...
	public void setTopic(String newTopic)
	{
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.PUBLISH__TOPIC, oldTopic, topic));
	}
	...
	public Event getEventType()
	{
		if (eventType != null && eventType.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.PUBLISH__EVENT_TYPE, oldEventType, eventType));
			}
		}
		return eventType;
	}
	...
	public void setEventType(Event newEventType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.PUBLISH__EVENT_TYPE, oldEventType, eventType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.PUBLISH__EVENT_BUS:
				return getEventBus();
			case JeeApplicationMmPackage.PUBLISH__TOPIC:
				return getTopic();
			case JeeApplicationMmPackage.PUBLISH__EVENT_TYPE:
