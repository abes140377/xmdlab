 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getModule <em>Module</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#isOptimisticLocking <em>Optimistic Locking</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#isCache <em>Cache</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getDatabaseTable <em>Database Table</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getExtendsName <em>Extends Name</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#isGapClass <em>Gap Class</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getInheritance <em>Inheritance</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getDiscriminatorColumnValue <em>Discriminator Column Value</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#isAggregateRoot <em>Aggregate Root</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getBelongsToAggregate <em>Belongs To Aggregate</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getOperations <em>Operations</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.DomainObjectImpl#getTraits <em>Traits</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DomainObjectImpl extends NamedElementImpl implements DomainObject
{
	...
	{
		return JeeApplicationMmPackage.Literals.DOMAIN_OBJECT;
	}
	...
	public EList<Reference> getReferences()
	{
		if (references == null)
		{
			references = new EObjectContainmentWithInverseEList<Reference>(Reference.class, this, JeeApplicationMmPackage.DOMAIN_OBJECT__REFERENCES, JeeApplicationMmPackage.REFERENCE__FROM);
		}
		return references;
	}
		...
		if (extends_ != null && extends_.eIsProxy())
		{
			...
			if (extends_ != oldExtends)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.DOMAIN_OBJECT__EXTENDS, oldExtends, extends_));
			}
		}
		return extends_;
	}
	...
	public void setExtends(DomainObject newExtends)
	{
		...
		extends_ = newExtends;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__EXTENDS, oldExtends, extends_));
	}
	...
	public EList<Attribute> getAttributes()
	{
		if (attributes == null)
		{
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, JeeApplicationMmPackage.DOMAIN_OBJECT__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setAbstract(boolean newAbstract)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__ABSTRACT, oldAbstract, abstract_));
	}
	...
	public NotificationChain basicSetRepository(Repository newRepository, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__REPOSITORY, oldRepository, newRepository);
	...
	public void setRepository(Repository newRepository)
	{
		if (newRepository != repository)
		{
			...
			if (repository != null)
				msgs = ((InternalEObject)repository).eInverseRemove(this, JeeApplicationMmPackage.REPOSITORY__AGGREGATE_ROOT, Repository.class, msgs);
			if (newRepository != null)
				msgs = ((InternalEObject)newRepository).eInverseAdd(this, JeeApplicationMmPackage.REPOSITORY__AGGREGATE_ROOT, Repository.class, msgs);
			msgs = basicSetRepository(newRepository, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__REPOSITORY, newRepository, newRepository));
	}
	...
	{
		if (eContainerFeatureID() != JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newModule, JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE, msgs);
		return msgs;
	}
	...
	{
		if (newModule != eInternalContainer() || (eContainerFeatureID() != JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE && newModule != null))
		{
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, JeeApplicationMmPackage.MODULE__DOMAIN_OBJECTS, Module.class, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE, newModule, newModule));
	}
	...
	public void setOptimisticLocking(boolean newOptimisticLocking)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__OPTIMISTIC_LOCKING, oldOptimisticLocking, optimisticLocking));
	}
	...
	public void setCache(boolean newCache)
	{
		...
		cache = newCache;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__CACHE, oldCache, cache));
	}
	...
	public void setPackage(String newPackage)
	{
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__PACKAGE, oldPackage, package_));
	}
	...
	public void setDatabaseTable(String newDatabaseTable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__DATABASE_TABLE, oldDatabaseTable, databaseTable));
	}
	...
	public void setExtendsName(String newExtendsName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__EXTENDS_NAME, oldExtendsName, extendsName));
	}
	...
	public void setValidate(String newValidate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__VALIDATE, oldValidate, validate));
	}
	...
	public void setGapClass(boolean newGapClass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__GAP_CLASS, oldGapClass, gapClass));
	}
	...
	public Inheritance getInheritance()
	{
		if (inheritance != null && inheritance.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.DOMAIN_OBJECT__INHERITANCE, oldInheritance, inheritance));
			}
		}
		return inheritance;
	}
	...
	public void setInheritance(Inheritance newInheritance)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__INHERITANCE, oldInheritance, inheritance));
	}
	...
	public void setDiscriminatorColumnValue(String newDiscriminatorColumnValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__DISCRIMINATOR_COLUMN_VALUE, oldDiscriminatorColumnValue, discriminatorColumnValue));
	}
	...
	public void setAggregateRoot(boolean newAggregateRoot)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__AGGREGATE_ROOT, oldAggregateRoot, aggregateRoot));
	}
	...
	public DomainObject getBelongsToAggregate()
	{
		if (belongsToAggregate != null && belongsToAggregate.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.DOMAIN_OBJECT__BELONGS_TO_AGGREGATE, oldBelongsToAggregate, belongsToAggregate));
			}
		}
	...
	public void setBelongsToAggregate(DomainObject newBelongsToAggregate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.DOMAIN_OBJECT__BELONGS_TO_AGGREGATE, oldBelongsToAggregate, belongsToAggregate));
	}
	...
	public EList<DomainObjectOperation> getOperations()
	{
		if (operations == null)
		{
			operations = new EObjectContainmentWithInverseEList<DomainObjectOperation>(DomainObjectOperation.class, this, JeeApplicationMmPackage.DOMAIN_OBJECT__OPERATIONS, JeeApplicationMmPackage.DOMAIN_OBJECT_OPERATION__DOMAIN_OBJECT);
		}
		return operations;
	}
	...
	public EList<Trait> getTraits()
	{
		if (traits == null)
		{
			traits = new EObjectResolvingEList<Trait>(Trait.class, this, JeeApplicationMmPackage.DOMAIN_OBJECT__TRAITS);
		}
		return traits;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.DOMAIN_OBJECT__REFERENCES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getReferences()).basicAdd(otherEnd, msgs);
			case JeeApplicationMmPackage.DOMAIN_OBJECT__REPOSITORY:
				if (repository != null)
					msgs = ((InternalEObject)repository).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JeeApplicationMmPackage.DOMAIN_OBJECT__REPOSITORY, null, msgs);
				return basicSetRepository((Repository)otherEnd, msgs);
			case JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetModule((Module)otherEnd, msgs);
			case JeeApplicationMmPackage.DOMAIN_OBJECT__OPERATIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case JeeApplicationMmPackage.DOMAIN_OBJECT__ATTRIBUTES:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE:
				return eInternalContainer().eInverseRemove(this, JeeApplicationMmPackage.MODULE__DOMAIN_OBJECTS, Module.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case JeeApplicationMmPackage.DOMAIN_OBJECT__EXTENDS:
				if (resolve) return getExtends();
				return basicGetExtends();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__ATTRIBUTES:
				return getAttributes();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__ABSTRACT:
				return isAbstract();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__REPOSITORY:
				return getRepository();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__MODULE:
				return getModule();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__OPTIMISTIC_LOCKING:
				return isOptimisticLocking();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__CACHE:
				return isCache();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__PACKAGE:
				return getPackage();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__DATABASE_TABLE:
				return getDatabaseTable();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__EXTENDS_NAME:
				return getExtendsName();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__VALIDATE:
				return getValidate();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__GAP_CLASS:
				return isGapClass();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__INHERITANCE:
				if (resolve) return getInheritance();
				return basicGetInheritance();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__DISCRIMINATOR_COLUMN_VALUE:
				return getDiscriminatorColumnValue();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__AGGREGATE_ROOT:
				return isAggregateRoot();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__BELONGS_TO_AGGREGATE:
				if (resolve) return getBelongsToAggregate();
				return basicGetBelongsToAggregate();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__OPERATIONS:
				return getOperations();
			case JeeApplicationMmPackage.DOMAIN_OBJECT__TRAITS:
				return getTraits();
		}
