 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.SubscribeImpl#getEventBus <em>Event Bus</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.SubscribeImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubscribeImpl extends MinimalEObjectImpl.Container implements Subscribe
{
	...
	{
		return JeeApplicationMmPackage.Literals.SUBSCRIBE;
	}
	...
	public void setEventBus(String newEventBus)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.SUBSCRIBE__EVENT_BUS, oldEventBus, eventBus));
	}
	...
	public void setTopic(String newTopic)
	{
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.SUBSCRIBE__TOPIC, oldTopic, topic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.SUBSCRIBE__EVENT_BUS:
				return getEventBus();
			case JeeApplicationMmPackage.SUBSCRIBE__TOPIC:
				return getTopic();
		}
