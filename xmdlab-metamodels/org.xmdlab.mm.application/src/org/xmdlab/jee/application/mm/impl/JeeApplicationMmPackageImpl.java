 ...
 * @generated
 */
public class JeeApplicationMmPackageImpl extends EPackageImpl implements JeeApplicationMmPackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.xmdlab.jee.application.mm.JeeApplicationMmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private JeeApplicationMmPackageImpl()
	{
		super(eNS_URI, JeeApplicationMmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link JeeApplicationMmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static JeeApplicationMmPackage init()
	{
		if (isInited) return (JeeApplicationMmPackage)EPackage.Registry.INSTANCE.getEPackage(JeeApplicationMmPackage.eNS_URI);

		// Obtain or create and register package
		JeeApplicationMmPackageImpl theJeeApplicationMmPackage = (JeeApplicationMmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof JeeApplicationMmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new JeeApplicationMmPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theJeeApplicationMmPackage.createPackageContents();

		// Initialize created meta-data
		theJeeApplicationMmPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theJeeApplicationMmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(JeeApplicationMmPackage.eNS_URI, theJeeApplicationMmPackage);
		return theJeeApplicationMmPackage;
	}
	 ...
	 * @generated
	 */
	public JeeApplicationMmFactory getJeeApplicationMmFactory()
	{
		return (JeeApplicationMmFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents()
	{
		...
		initEClass(enumEClass, org.xmdlab.jee.application.mm.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnum_Values(), this.getEnumValue(), null, "values", null, 0, -1, org.xmdlab.jee.application.mm.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnum_Ordinal(), ecorePackage.getEBoolean(), "ordinal", null, 0, 1, org.xmdlab.jee.application.mm.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
