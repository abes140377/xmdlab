 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isChangeable <em>Changeable</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#getDatabaseType <em>Database Type</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isNaturalKey <em>Natural Key</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#getLength <em>Length</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isIndex <em>Index</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#getDatabaseColumn <em>Database Column</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.AttributeImpl#isTransient <em>Transient</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends TypedElementImpl implements Attribute
{
	...
	{
		return JeeApplicationMmPackage.Literals.ATTRIBUTE;
	}
	...
	public void setChangeable(boolean newChangeable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__CHANGEABLE, oldChangeable, changeable));
	}
	...
	public void setDatabaseType(String newDatabaseType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__DATABASE_TYPE, oldDatabaseType, databaseType));
	}
	...
	public void setNullable(boolean newNullable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__NULLABLE, oldNullable, nullable));
	}
	...
	public void setNaturalKey(boolean newNaturalKey)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__NATURAL_KEY, oldNaturalKey, naturalKey));
	}
	...
	public void setVisibility(String newVisibility)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__VISIBILITY, oldVisibility, visibility));
	}
	...
	public void setRequired(boolean newRequired)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__REQUIRED, oldRequired, required));
	}
	...
	public void setLength(String newLength)
	{
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__LENGTH, oldLength, length));
	}
	...
	public void setIndex(boolean newIndex)
	{
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__INDEX, oldIndex, index));
	}
	...
	public void setDatabaseColumn(String newDatabaseColumn)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__DATABASE_COLUMN, oldDatabaseColumn, databaseColumn));
	}
	...
	public void setValidate(String newValidate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__VALIDATE, oldValidate, validate));
	}
	...
	public void setTransient(boolean newTransient)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.ATTRIBUTE__TRANSIENT, oldTransient, transient_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.ATTRIBUTE__CHANGEABLE:
				return isChangeable();
			case JeeApplicationMmPackage.ATTRIBUTE__DATABASE_TYPE:
				return getDatabaseType();
			case JeeApplicationMmPackage.ATTRIBUTE__NULLABLE:
				return isNullable();
			case JeeApplicationMmPackage.ATTRIBUTE__NATURAL_KEY:
				return isNaturalKey();
			case JeeApplicationMmPackage.ATTRIBUTE__VISIBILITY:
				return getVisibility();
			case JeeApplicationMmPackage.ATTRIBUTE__REQUIRED:
				return isRequired();
			case JeeApplicationMmPackage.ATTRIBUTE__LENGTH:
				return getLength();
			case JeeApplicationMmPackage.ATTRIBUTE__INDEX:
				return isIndex();
			case JeeApplicationMmPackage.ATTRIBUTE__DATABASE_COLUMN:
				return getDatabaseColumn();
			case JeeApplicationMmPackage.ATTRIBUTE__VALIDATE:
				return getValidate();
			case JeeApplicationMmPackage.ATTRIBUTE__TRANSIENT:
				return isTransient();
		}
