 ...
 * <ul>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isMany <em>Many</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getCollectionType <em>Collection Type</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getOrderBy <em>Order By</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isChangeable <em>Changeable</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isCache <em>Cache</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isNaturalKey <em>Natural Key</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isInverse <em>Inverse</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isNullable <em>Nullable</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getDatabaseColumn <em>Database Column</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getDatabaseJoinTable <em>Database Join Table</em>}</li>
 *   <li>{@link org.xmdlab.jee.application.mm.impl.ReferenceImpl#getDatabaseJoinColumn <em>Database Join Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends NamedElementImpl implements Reference
{
	...
	{
		return JeeApplicationMmPackage.Literals.REFERENCE;
	}
	...
	public void setMany(boolean newMany)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__MANY, oldMany, many));
	}
	...
	public void setCollectionType(String newCollectionType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__COLLECTION_TYPE, oldCollectionType, collectionType));
	}
	...
	public Reference getOpposite()
	{
		if (opposite != null && opposite.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
			}
		}
		return opposite;
	}
	...
	public void setOpposite(Reference newOpposite)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__OPPOSITE, oldOpposite, opposite));
	}
	...
	public DomainObject getTo()
	{
		if (to != null && to.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JeeApplicationMmPackage.REFERENCE__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(DomainObject newTo)
	{
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__TO, oldTo, to));
	}
	...
	public void setCascade(String newCascade)
	{
		...
		cascade = newCascade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__CASCADE, oldCascade, cascade));
	}
	...
	public void setOrderBy(String newOrderBy)
	{
		...
		orderBy = newOrderBy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__ORDER_BY, oldOrderBy, orderBy));
	}
	...
	public void setVisibility(String newVisibility)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__VISIBILITY, oldVisibility, visibility));
	}
	...
	public void setChangeable(boolean newChangeable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__CHANGEABLE, oldChangeable, changeable));
	}
	...
	{
		if (eContainerFeatureID() != JeeApplicationMmPackage.REFERENCE__FROM) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newFrom, JeeApplicationMmPackage.REFERENCE__FROM, msgs);
		return msgs;
	}
	...
	{
		if (newFrom != eInternalContainer() || (eContainerFeatureID() != JeeApplicationMmPackage.REFERENCE__FROM && newFrom != null))
		{
			...
			if (newFrom != null)
				msgs = ((InternalEObject)newFrom).eInverseAdd(this, JeeApplicationMmPackage.DOMAIN_OBJECT__REFERENCES, DomainObject.class, msgs);
			msgs = basicSetFrom(newFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__FROM, newFrom, newFrom));
	}
	...
	public void setRequired(boolean newRequired)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__REQUIRED, oldRequired, required));
	}
	...
	public void setFetch(String newFetch)
	{
		...
		fetch = newFetch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__FETCH, oldFetch, fetch));
	}
	...
	public void setCache(boolean newCache)
	{
		...
		cache = newCache;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__CACHE, oldCache, cache));
	}
	...
	public void setNaturalKey(boolean newNaturalKey)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__NATURAL_KEY, oldNaturalKey, naturalKey));
	}
	...
	public void setInverse(boolean newInverse)
	{
		...
		inverse = newInverse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__INVERSE, oldInverse, inverse));
	}
	...
	public void setNullable(boolean newNullable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__NULLABLE, oldNullable, nullable));
	}
	...
	public void setDatabaseColumn(String newDatabaseColumn)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__DATABASE_COLUMN, oldDatabaseColumn, databaseColumn));
	}
	...
	public void setValidate(String newValidate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__VALIDATE, oldValidate, validate));
	}
	...
	public void setTransient(boolean newTransient)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__TRANSIENT, oldTransient, transient_));
	}
	...
	public void setDatabaseJoinTable(String newDatabaseJoinTable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__DATABASE_JOIN_TABLE, oldDatabaseJoinTable, databaseJoinTable));
	}
	...
	public void setDatabaseJoinColumn(String newDatabaseJoinColumn)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JeeApplicationMmPackage.REFERENCE__DATABASE_JOIN_COLUMN, oldDatabaseJoinColumn, databaseJoinColumn));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.REFERENCE__FROM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case JeeApplicationMmPackage.REFERENCE__FROM:
				return eInternalContainer().eInverseRemove(this, JeeApplicationMmPackage.DOMAIN_OBJECT__REFERENCES, DomainObject.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JeeApplicationMmPackage.REFERENCE__MANY:
				return isMany();
			case JeeApplicationMmPackage.REFERENCE__COLLECTION_TYPE:
				return getCollectionType();
			case JeeApplicationMmPackage.REFERENCE__OPPOSITE:
				if (resolve) return getOpposite();
				return basicGetOpposite();
			case JeeApplicationMmPackage.REFERENCE__TO:
				if (resolve) return getTo();
				return basicGetTo();
			case JeeApplicationMmPackage.REFERENCE__CASCADE:
				return getCascade();
			case JeeApplicationMmPackage.REFERENCE__ORDER_BY:
				return getOrderBy();
			case JeeApplicationMmPackage.REFERENCE__VISIBILITY:
				return getVisibility();
			case JeeApplicationMmPackage.REFERENCE__CHANGEABLE:
				return isChangeable();
			case JeeApplicationMmPackage.REFERENCE__FROM:
				return getFrom();
			case JeeApplicationMmPackage.REFERENCE__REQUIRED:
				return isRequired();
			case JeeApplicationMmPackage.REFERENCE__FETCH:
				return getFetch();
			case JeeApplicationMmPackage.REFERENCE__CACHE:
				return isCache();
			case JeeApplicationMmPackage.REFERENCE__NATURAL_KEY:
				return isNaturalKey();
			case JeeApplicationMmPackage.REFERENCE__INVERSE:
				return isInverse();
			case JeeApplicationMmPackage.REFERENCE__NULLABLE:
				return isNullable();
			case JeeApplicationMmPackage.REFERENCE__DATABASE_COLUMN:
				return getDatabaseColumn();
			case JeeApplicationMmPackage.REFERENCE__VALIDATE:
				return getValidate();
			case JeeApplicationMmPackage.REFERENCE__TRANSIENT:
				return isTransient();
			case JeeApplicationMmPackage.REFERENCE__DATABASE_JOIN_TABLE:
				return getDatabaseJoinTable();
			case JeeApplicationMmPackage.REFERENCE__DATABASE_JOIN_COLUMN:
