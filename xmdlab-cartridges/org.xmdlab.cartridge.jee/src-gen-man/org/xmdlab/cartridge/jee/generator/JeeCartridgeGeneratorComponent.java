 ...
 * Xtend Template: org.xmdlab.cartridge.generator.dsl.templates.generator.CartridgeGeneratorComponentTpl
 */
...
public class JeeCartridgeGeneratorComponent extends GeneratorComponent {
	...
	public void invoke(IWorkflowContext ctx) {
		...
		for (String slot : slotNames) {
			...
			if (object instanceof Resource) {
				...
				// init metafacades
				// ApplicationMetafacade applicationMetafacade =
				// injector.getInstance(ApplicationMetafacade.class);
				// org.xmdlab.mm.jee.application.Application modelElement =
				// EcoreUtil2.eAllOfType(resource.getAllContents().next(),
				// org.xmdlab.mm.jee.application.Application.class).get(0);
				// applicationMetafacade.setModelResource(modelElement);
